...
CANDIDATE="${1:-LR128}"
ARCHIVE_ROOT="${2:-submissions/quantizr/experiments/gpt_lowres_mask}"
...
case "$CANDIDATE" in
  LR128|lr128)
    NAME="crf42_mask128x96_zpose8i4_zseg2x4x6i4"
    EXTRA_ARGS=(--crf 42 --mask-encode-size 128x96 --z-dim 8 --z-seg-channels 2 --z-seg-h 4 --z-seg-w 6)
    ;;
  LR96|lr96)
    NAME="crf38_mask96x72_zpose8i4_zseg3x4x6i4"
    EXTRA_ARGS=(--crf 38 --mask-encode-size 96x72 --z-dim 8 --z-seg-channels 3 --z-seg-h 4 --z-seg-w 6)
    ;;
  LR192|lr192)
    NAME="crf46_mask192x144_zpose8i4_zseg1x4x6i4"
    EXTRA_ARGS=(--crf 46 --mask-encode-size 192x144 --z-dim 8 --z-seg-channels 1 --z-seg-h 4 --z-seg-w 6)
    ;;
  *)
